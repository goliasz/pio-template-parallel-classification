...
object EngineParamsList extends EngineParamsGenerator {
  ...
  engineParamsList = Seq(
    baseEP.copy(algorithmParamsList = Seq(("naive", NBAlgorithmParams(10.0)))),
    baseEP.copy(algorithmParamsList = Seq(("naive", NBAlgorithmParams(100.0)))),
    baseEP.copy(algorithmParamsList = Seq(("naive", NBAlgorithmParams(1000.0)))))
}
